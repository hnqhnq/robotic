...
@dataclass
class QwenVL2dot5_3B_LIBERO(VLAConfig):
    vla_id: str = "qwen-vl2.5-3b+mx-libero"
    base_vlm: Union[str, Path] = "Qwen/Qwen2.5-VL-3B-Instruct"

    # full fine-tuning setting, so nothing is frozen
    freeze_vision_backbone: bool = False
    freeze_llm_backbone: bool = False
    unfreeze_last_llm_layer: bool = False # actually the if else branch will not use this variable
...
class VLARegistry(Enum):
    ...
    # QWEN VL2.5 3B + Libero ft
    QWEN_VL2DOT5_3B_MX_LIBERO = QwenVL2dot5_3B_LIBERO
