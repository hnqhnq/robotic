...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    ...
    def forward(
        ...
        # === Handle Multimodal Forward ===
            ...
            import tqdm
            tqdm.tqdm.write(f"input_embeddings: {input_embeddings.shape}")
            ...
            tqdm.tqdm.write(f"multimodal_embeddings: {multimodal_embeddings.shape}")
            tqdm.tqdm.write(f"multimodal_attention_mask: {multimodal_attention_mask.shape}")
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _regression_or_discrete_prediction(
        ...
        actions_hidden_states = last_hidden_states[
            :,
            NUM_PATCHES + NUM_PROMPT_TOKENS -1 : NUM_PATCHES + NUM_PROMPT_TOKENS + ACTION_DIM * NUM_ACTIONS_CHUNK -1 ,
            :,
        ]  # (B, act_chunk_len, D)
        print("i change here")
